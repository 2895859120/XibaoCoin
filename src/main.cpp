...
//#1
int64 nChainStartTime = 1488262824;
...
const string strMessageMagic = "Xibaocoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Xibaocoin
    bool fStrictPayToScriptHash = true; // Always active in Xibaocoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Xibaocoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        //#1
        const char* pszTimestamp = "Xibaocoin created by SMITH 2017/02/28";
        CTransaction txNew;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        //#1
        assert(block.hashMerkleRoot == uint256("0x840d2c1945e2e7cf4990333d01578f1bf315dfe8d1e1da340645365410402ab7"));
